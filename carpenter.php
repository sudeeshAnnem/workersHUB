...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work`='epc' OR `work`='ec' OR `work`='cp' OR `work`='c'";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="carpenter.php"><i class="fa fa-circle-o"></i> Carpentery Works</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Carpentry Works</li>
      </ol>
    </section>
