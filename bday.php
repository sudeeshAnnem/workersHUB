...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work2`='b' OR `work2`='bwp'";
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="computer.php"><i class="fa fa-circle-o"></i>Computers</a></li>
          </ul>
        </li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="bday.php"><i class="fa fa-circle-o"></i> Birhtday Events</a></li>
