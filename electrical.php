...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work`='epc' OR `work`='ep' OR `work`='ec'  OR `work`='e'";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li   class="active"><a href="electrical.php"><i class="fa fa-circle-o"></i> Electrical Works</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Electrical Works</li>
      </ol>
    </section>
