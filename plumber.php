...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work`='epc' OR `work`='ep' OR `work`='cp' OR `work`='p'";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="plumber.php"><i class="fa fa-circle-o"></i> Plumbering Works</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Plumbering Works</li>
      </ol>
    </section>
