...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work1`='t' OR `work1`='tm' OR `work1`='tmacrc'";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="television.php"><i class="fa fa-circle-o"></i>Television</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Television Works</li>
      </ol>
    </section>
