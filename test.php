...
$db = mysqli_connect("localhost", "root", "", "workershub");
if(isset($_POST['POST']))
{
  ...
  $adhar=$_POST['adhar'];
	...
	if($pass==$cpass)
	{
			 		   ...
			 		   $sql="INSERT INTO `users`(`Aadhar`, `name`, `phone`, `password`, `email`, `photo`) VALUES ('$adhar','$name','$phone','$pass','$email','$image')";
...
.alert-success {
  ...
  function Validate() {
    ...
    var a = document.forms["myForm"]["cpass"].value;
   // If x is Not a Number or less than one or greater than 10
    if (isNaN(x) || x.length!= 12) {
      alert("Aadhar card should be 12 characters");
        return false;
    }
    elseif(z.length<8|| a.length<8){
...
<div class="body-content">
  <div class="module">
    <center><img src="images/image.png" height="150px" width="150px"></center>
    <center><h1 style="font-size: 30px;font-weight:italic;color: red;font-family: "Times New Roman", Times, serif;">Worker`s HUB</h1></center>
    <h1>Create an account as an USER</h1>
    <form name="myForm" class="form" action="" method="post" onsubmit="return Validate()" enctype="multipart/form-data" autocomplete="off">
      <div class="alert alert-error"></div>
      <input type="number" placeholder="Enter 12 digit aadhar number" name="adhar" required />
