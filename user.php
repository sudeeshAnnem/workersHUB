  ...
  $adhar=$_POST['adhar'];
	...
	if($pass==$cpass)
	{
            ...
            if($query)
            {
            	 ...
            	 echo '<script type="text/javascript">'; 
                  echo 'alert("Problem exsists with your data!!");'; 
...
<div class="body-content">
  <div class="module">
  	<center><img src="images/user.png" height="150px" width="150px"></center>
    ...
    <form class="form" action="" name="myForm" onsubmit="return validateForm()"  method="post" enctype="multipart/form-data" autocomplete="off">
