...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" name="myForm" onsubmit="return validateForm()" action="" method="post" enctype="multipart/form-data" autocomplete="off">
      <div class="alert alert-error"></div>
      <input type="number" placeholder="Enter 12 digit aadhar number" name="adhar" required/>      <input type="submit" value="Register" name="post" class="btn btn-block btn-primary" />
    </form>
  </div>
</div>
