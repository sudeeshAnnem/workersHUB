...
if(isset($_POST['sent']))
{
  ...
  $query="select `name` from `workers` where `email`='$mail'";
  $result=mysqli_query($conn,$query);
  $row=mysqli_fetch_array($result);
  $name=$row['name'];
  $query1="INSERT INTO `transactions_inbox`(`wname`, `uname`, `date`, `content`,`subject`) VALUES ('$name','$user','$date','$textarea','$subject')";
  $result1=mysqli_query($conn,$query1);
  if($result1)
  {
      echo '<script type="text/javascript">'; 
echo 'alert("Your message has been successfully sent");'; 
echo 'window.location.href = "electrical.php";';
echo '</script>';
  }
}
?>
...
<head>
  ...
  <title>Workers Transaction</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      ?>
                <p>
                  <?php echo $user; ?> - Household Worker
                </p>
              </li>
              <!-- Menu Body -->
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Mail Box</span>
          </a>
        </li>         
      </ul>
    </section>
          ...
          <form action="" method="POST">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="To:<?php echo $email; ?>" value="">
              ...
              <div class="form-group">
                <input class="form-control" type="date" name="date" placeholder="Enter the booking date:">
              </div>
              <div class="form-group">
