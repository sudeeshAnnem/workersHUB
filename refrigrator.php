...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work1`='r' OR `work1`='acr' OR `work1`='tmacrc'";
        ...
        <li class="treeview">
         ...
         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="refrigrator.php"><i class="fa fa-circle-o"></i>Refrigirators</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Refrigrator Works</li>
      </ol>
    </section>
