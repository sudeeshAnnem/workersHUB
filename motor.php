...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work1`='m' OR `work1`='tm' OR `work1`='tmacrc'";
        ...
        <li class="treeview">
         ...
         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="motor.php"><i class="fa fa-circle-o"></i>Motors</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Motor Works</li>
      </ol>
    </section>
