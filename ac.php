...
include 'session.php';
include 'db.php';
$sql="SELECT * FROM `workers` WHERE `work1`='ac' OR `work1`='tmacrc'";
   ...
   <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      ?>
        ...
        echo "<img src='images/".$row['photo']."' class='img-circle' width='10px' height='50px'>";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="electrical.php"><i class="fa fa-circle-o"></i> Electrical Works</a></li>
         ...
         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ac.php"><i class="fa fa-circle-o"></i>Air Conditioners</a></li>
            ...
            <li><a href="computer.php"><i class="fa fa-circle-o"></i>Computers</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Air Conditioner Works</li>
      </ol>
    </section>
      ...
      <form action="workers_transact.php" method="POST">
        <div class="caption">
          ...
          <table> 
           ...
           <td><input type="hidden" name="email1" value="<?php echo $row['email'];?>"></td>
           </tr>
           <tr> 
           <td>Age:</td>
